...
DROP TABLE IF EXISTS alarm_definition_severity;
DROP TABLE IF EXISTS notification_method_type;

DROP TABLE IF EXISTS stream_actions_action_type;
DROP TABLE IF EXISTS schema_migrations;
DROP TABLE IF EXISTS stream_actions;
DROP TABLE IF EXISTS stream_definition;
DROP TABLE IF EXISTS event_transform;
