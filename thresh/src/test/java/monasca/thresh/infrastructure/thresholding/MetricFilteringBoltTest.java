...
public class MetricFilteringBoltTest {
  ...
  public void testAllInitialSporadic() {
    MetricFilteringBolt.clearMetricDefinitions();

    final String expression1 = "count(log.warning{path=/var/log/test_1.log},sporadic=true,1) > 5";
    final String expression2 = "count(log.warning{path=/var/log/test_2.log},sporadic=true,1) > 5";
