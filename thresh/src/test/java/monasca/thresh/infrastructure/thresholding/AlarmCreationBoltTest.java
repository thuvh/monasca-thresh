...
public class AlarmCreationBoltTest {
  ...
  public void testReuseMetricFromExistingAlarm() {
    ...
    verifyCreatedAlarm(this.createdAlarms.get(0), alarmDefinition, false, collector,
    ...
    verifyCreatedAlarm(this.createdAlarms.get(1), alarmDefinition, false, collector,
