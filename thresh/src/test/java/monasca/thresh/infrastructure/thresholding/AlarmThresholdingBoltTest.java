...
public class AlarmThresholdingBoltTest {
  ...
  protected void beforeMethod() {
    ...
    alarmDefinition.setId("42424242");
    alarmDefinition.setTenantId(tenantId);
    alarmDefinition.setDescription("Description of Alarm");
    alarmDefinition.setName("Test CPU Alarm");
    final String expression = builder.toString();
    alarmDefinition.setExpression(expression);
    alarm = new Alarm(alarmId, alarmDefinition, AlarmState.OK);
    alarm.setAlarmDefinitionId(alarmDefinition.getId());
