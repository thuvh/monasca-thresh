...
public class MetricAggregationBoltTest {
  ...
  protected void beforeClass() {
    ...
    subExpr4 = new SubExpression("777", AlarmSubExpression.of("count(log.error{id=5},sporadic,60) >= 5"));
  ...
  public void shouldEvaluateAlarms() {
    ...
    assertEquals(subAlarm4.getState(), AlarmState.OK); // sporadic
  ...
  public void shouldNeverLeaveOkIfThresholdNotExceededForSporadic() {
    long t1 = 50000;
    bolt.setCurrentTime(t1);
    sendSubAlarmCreated(metricDef4, subAlarm4);
  ...
  public void shouldSendOKOnStartupForSporadic() {
    long t1 = 14000;
    bolt.setCurrentTime(t1);
    sendSubAlarmCreated(metricDef4, subAlarm4);
