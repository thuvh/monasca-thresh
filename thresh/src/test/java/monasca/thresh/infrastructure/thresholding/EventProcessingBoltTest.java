...
public class EventProcessingBoltTest {
  ...
  protected void beforeMethod() {
    ...
    alarmDefinition = new AlarmDefinition("424242", TENANT_ID, name, description, alarmExpression, Boolean.TRUE);
  ...
  public void testAlarmDeletedEvent() {
    ...
    final AlarmDeletedEvent event =
        new AlarmDeletedEvent(alarm.getId(), alarmedMetricsDefs, alarmDefinition.getId(), subAlarmMetricDefs);
    final Tuple tuple = createTuple(event);
    bolt.execute(tuple);
