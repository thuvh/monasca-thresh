...
public class SubAlarm extends AbstractEntity implements Serializable {
   ...
   * Note:
   *  If sub alarm has no expression this method will return
   *  {@value AlarmSubExpression#DEFAULT_DETERMINISTIC}.
   *
   * @return true/false
   * @see monasca.common.model.alarm.AlarmSubExpression#isDeterministic()
   */
  public boolean isDeterministic() {
    return this.expression == null ? AlarmSubExpression.DEFAULT_DETERMINISTIC : this.expression
        .isDeterministic();
  }
  ...
  public boolean isCompatible(final AlarmSubExpression other) {
    ...
    if (this.expression.isDeterministic() != other.isDeterministic()){
      return false;
    }
