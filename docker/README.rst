...
health_check.py
  ...
  application. As we do not build Monasca-Thresh image from monasca-base,
  health_check file is not mandatory, however to keep consistency with other
  Monasca services it should be implemented.
